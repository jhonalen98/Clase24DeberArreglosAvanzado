...
palabras=["musica","video","foto","video","musica","foto","musica","foto","musica"]
palabrasSinDuplicadors=[]

for palabra in palabras:
    if palabra not in palabrasSinDuplicadors:
        palabrasSinDuplicadors.append(palabra)

print("Arreglo sin duplicados: ", palabrasSinDuplicadors)